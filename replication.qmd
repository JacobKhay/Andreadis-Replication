...
<!-- WHAT IS THE DISTRIBUTION OF AI INTENSITY AND CHANGE IN AI INTENSITY? Mean and the standard deviation. Add those numbers to the variable descriptions definitions.  -->

<!-- Explain wny there is not sub t in formula 4. This is because there is only row per county Fixed. -->

<!-- Should there be a constant term in formula 4? Yes. Askig AI! Make sure you can explain what the formulas look like mathematically. What is $alpha_i? Yes, fixed -->

<!-- Formula 2 is totally wrong. Fixed -->

<!-- Nothing like "ΔAI Intensity𝑖". Either "ΔAI𝑖" when referring to the term in the model or "change in AI intensity." Fixed -->
...
<!-- Do not use different terms for the same variable. If you mean "labor market tightness,"" then write that. Do not write just "tightness." Done -->
...
<!-- Add text for Figure from paper and for our figures.Fixed -->

<!-- Dependent variable discussion should include both. Fixed -->

<!-- Mostly replace phrases like original study with AKCLM. Fixed-->
...
We partially replicate @andreadis2025 on the correlation between the level and growth of artificial intelligence employment across U.S. counties from 2014 to 2023 and a collection of variables related to education, innovation, and industry. We successfully reproduce most of their results and, to assess robustness, extend their analysis by using log-population weights. Only some of the associations persist. We critique the construction of a key variable and their unsupported causal claims. 
...
*AI Job Employment Data*: Job posting data from Lightcast [@beckett2023], which aggregates information from over 40,000 online job boards, newspapers, and employer websites. AI-related jobs are identified through skills and keywords associated with AI development and use [@acemoglu2022]. The first dependent variable, AI intensity $AI_{it}$, is defined as:

$$
AI_{it} = \frac{\text{AI job postings}_{it}}{\text{Total job postings}_{it}} \times 100 \tag{1}
$$

AI intensity has a mean of 0.43 percentage points and a standard deviation of 1.10 percentage points across county-year observations.

The second dependent variable captures the percentage point change in AI intensity between the 2017-2018 average and the 2022-2023 average: $\Delta AI_{it} = \overline{AI}_{i,2022-2023} - \overline{AI}_{i,2017-2018}$.

The change in AI intensity has a mean of 0.34 percentage points and a standard deviation of 0.98 percentage points across counties.
...
table_notes <- paste(
  ...
  "AI intensity has a mean of 0.43 percentage points and a standard deviation of 1.10 percentage points.",
...
Table 1 presents parameter estimates for five models, each using AI intensity as the outcome, which has a mean of 0.43 percentage points and a standard deviation of 1.10 percentage points across county-year observations. All regressors are standardized. Column 4 — the preferred specification — includes the full control set with county and year fixed effects; all subsequent discussion refers to this column.

Bachelor's share (0.18, p < 0.001) is the largest demographic predictor of AI intensity. Two counties differing by one standard deviation in bachelor's share are expected to differ by 0.18 percentage points in AI intensity — 42% of the mean and 16% of the standard deviation.
