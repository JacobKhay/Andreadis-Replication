...
<!-- DK: Your graphic needs bigger font. Also, log-pop label key after original. -->

<!-- DK: Make the font in the tables a little bigger. -->

<!-- DK: Equation is good but does not belong in the introduction. -->

<!-- DK: Make introduction more connected to our new abstract. First paragraph is general why this is important. Second paragraph explains the left side variables. Third explains the right side variables. Fourth paragraph explains their main results. Fifth paragraph explains what happens when you log-pop weight. Last paragraph talks about causal stuff. -->
