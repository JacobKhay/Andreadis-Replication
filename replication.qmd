...
<!-- 1) Fix DK notes below. Delete them.  -->

<!-- 2) Send latest draft to AKCLM, mentioning in email how we note that they have failed to explain the discrepancies. cc me. -->

<!-- 3) Submit! (Note you need a version without our names.) Run once, save and rename replication.tex as akclm.tex. Remove our names. Run again, save replication.tex as akclm-no-names.tex. -->

<!-- DK: I dislike "For the growth outcome". Use our standard term, always. -->
...
table_notes <- paste(
  ...
  "in total job postings in each county-year from 2014 through 2023, multiplied by 100 to express in percentage terms.",
...
We reproduce Table 2 from AKCLM. All our results match AKCLM's, except for coefficient and standard error for bachelor's share in all the models in which it appears. The source of this discrepancy is unclear; the authors were contacted but did not respond.
...
table_notes <- paste(
  ...
  "Standard errors are clustered at the county level.",
  "Our replication matches AKCLM perfectly, except for the coefficient and standard error for bachelor's share for all the models in which it appears.",
...
<!-- DK: These variables are wrong. -->

This replication of AKCLM confirms that labor market conditions, human capital, and innovation capacity are correlated with AI intensity across U.S. counties. Our analysis highlights three qualifications to their conclusions.

First, AKCLM employ causal language that overstates what the empirical design can support. Terms such as "drivers" and "determinants" suggest causal mechanisms, but simple regressions can only document conditional correlations, in the absence of an explicit identification strategy [@holland1986], 

Second (DK: Add discussion of bad labor market intensity.)

Third, several associations are sensitive to the weighting scheme. ICT intensity shows the largest magnitude shift, declining by approximately 42% under log-population weights, while patents per employee, STEM degree share, and turnover rate all decline by roughly one-third.
