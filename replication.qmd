...
<!-- Do not do this! "though effect sizes diminish when larger counties receive less weight." Instead of just saying log-weighted, as you should, you are coming up with different English words for no good reason. Maybe "though effect sizes diminish when we weight by the logaroithm of county population."-->
