...
<!-- Use: citation("modelsummary") and similarly for the other R packages.  yes. done.-->

<!-- Weird space: Babina, Tania,Anastassia Fedyk,Alex He, andJames Hodson. 2024. “Artificial intelligence --- weird space after quote, only appear if rendered.?? -->

<!-- 103745 is wrong. Check each reference by hand. I checked it, it shows working paper 103745-->

<!-- Science384(6702) : 1306–1308 --- spaces around colon seems weird. couldn't figure this one out -->

<!-- Does every entry need a DOI or a URL? Yes. done. -->
