...
AKCLM focus on their Model 4 for both dependent variables: AI intensity and the change in AI intensity. With equal weighting, the coefficients of bachelor's share, labor market tightness, patents per employee, STEM degree share, and manufacturing intensity are statistically significant in the levels specification, and STEM degree share is significant in the growth specification. When regressions are instead weighted by the log of county population, tightness, patents per employee, and manufacturing intensity lose significance in the levels specification, while bachelor's share and turnover rate become newly significant. Three coefficients that were significant under equal weighting are no longer significant under log-population weighting, suggesting that AKCLM's results are partially sensitive to the implicit assumption that each county contributes equally to the estimation.
