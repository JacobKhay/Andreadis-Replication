...
<!-- SEND EMAIL! Reply all, including me, to the last email about the table. "Just following up on this issue.

Also, we are unable to replicate the maps. For example, your published maps include data for Connecticut, but your data file, downloaded from http:..., does not include data for Connecticut. " -->
...
<!-- Try cite fixest, map stuff, kableExtra, especially if there is an article to which we can easily point -->
