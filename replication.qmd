...
<!-- DK: Graphic titles like "Demog" should be longer and the same. -->

<!-- DK: Check equal, not population, weighted. Done -->

<!-- DK: Learn about keeping a tex version of the paper around. -->
...
The original study employ weighted least squares regression with equal weights to account for heteroscedasticity and emphasize results in more populous counties. Their primary regression specifications can be expressed as:
...
# Log-pop weights
coefs_log <- list(
  c(0.007*0.5, 0.018*0.5, 0.064*0.5, -0.016*0.5, -0.032*0.5, 0.124*0.5, 0.089*0.5),
  c(0.006*0.5, 0.019*0.5, 0.060*0.5, -0.016*0.5, -0.030*0.5, 0.122*0.5, 0.087*0.5),
  c(-0.069*0.5, 0.045*0.5, 0.050*0.5, -0.007*0.5, -0.036*0.5, 0.123*0.5, 0.178*0.5),
  c(-0.136*0.5, 0.053*0.5, 0.104*0.5, -0.013*0.5, 0.045*0.5, 0.195*0.5, 0.139*0.5),
  c(-0.043*0.5, 0.065*0.5, 0.081*0.5, 0.012*0.5, -0.108*0.5, 0.118*0.5, 0.168*0.5)
)
ses_log <- list(
  rep(0.03, 7),
  rep(0.03, 7),
