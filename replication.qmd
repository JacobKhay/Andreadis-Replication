...
<!-- Fix tables. Coeeficient estimates must match up with wording, with standard errors directly below. -->

<!-- Bigger legend for maps. -->

<!-- Maps go beyond square, seem off-kilter. -->

<!-- Avoid "original weights" as a term. The original analysis used "equal weights." A phrase like " instead of the original weights." should be replaced with something like "instead of equal weights, as used by Andrediids et al 2025. -->
...
To assess the robustness of the original findings, we re-estimated all models using log-population weights instead of the original weights. 
