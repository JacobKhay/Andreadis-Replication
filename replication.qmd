...
<!-- DK: Look over prose closely. Give AI each paragraph one at a time, after setting up the context. "You are a PhD economist writing an academic paper. ... "  -->
...
<!-- DK: Make introduction more connected to our new abstract. First paragraph is general why this is important. Second paragraph explains the left side variables. Third explains the right side variables. Fourth paragraph explains their main results. Fifth paragraph explains what happens when you log-pop weight. Last paragraph talks about causal stuff. Done-check please -->
...
# Updated labels with slightly smaller font size commands
labels <- c(
  "share_bac" = "\\Large{Bachelor's share, z-score}",
  "share_black" = "\\Large{Black pop, z-score}",
  "share_poverty" = "\\Large{Poverty share, z-score}",
  "logpop" = "\\Large{log(Population), z-score}",
  "hpi_ch" = "\\Large{House Price Growth, z-score}",
  "logincome" = "\\Large{log(Median Income), z-score}",
  "tightness" = "\\Large{Labor Market Tightness, z-score}",
  "pat_intensity" = "\\Large{Patents per employee, z-score}",
  "patai_intensity" = "\\Large{AI patents' share, z-score}",
  "degshare" = "\\Large{Degrees awarded per capita, z-score}",
  "stemshare" = "\\Large{STEM Degrees' share, z-score}",
  "large_firms" = "\\Large{Large Establishments, z-score}",
  "information_intensity" = "\\Large{ICT sector Intensity, z-score}",
  "manuf_intensity" = "\\Large{Manufacturing Intensity, z-score}",
  "TurnOvrS" = "\\Large{Turnover Rate, z-score}"
)
...
modelsummary(
  ...
  kable_styling(
    latex_options = c("hold_position", "scale_down"),  # Retained scale_down to fit page
    full_width = FALSE,
    font_size = 14,  # Increased font size to make actual values larger
    position = "center"
  ) |>
  column_spec(1, width = "5.5cm") |>   # Adjusted for better fit
  column_spec(2:6, width = "2cm") |>  # Standard column widths
