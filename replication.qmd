...
<!-- DK: Do not use LaTeX unless you have a compelling reason. fancyheader? -->

<!-- DK: Code must generate the tables. No copy/paste in replication. -->

<!-- DK: Use fig.cap, not headers, for caoptions in table. -->

<!-- DK: get rid of causation discussion. -->

<!-- DK: Our plot should look like their plot. Check Alaska. -->
