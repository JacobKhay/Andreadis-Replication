...
<!-- Search for plot making code by searching in files for a string like "2023 average". May appear in many places! Goal is to get the font for the legend bigger. If that doesn't work, email your author contact. -->

<!-- Causal discussion comes at end. Done  -->

<!-- 9 over Official Weights Done -->

<!-- All of our plots are one column panels. Done -->

<!-- Fix references.  -->

<!-- Is the last reference in their paper really Makridis, Christos A.,? Check the text of the paper. -->

<!-- Ask AI to give you a paragraph summary of each reference. Read it. Confirm, by hand, that you are using the references correctly! -->

<!-- Our bibliography does not match the journals formatting. Probably need a different csl. AI will help. Done-->
...
map_theme <- theme_void() +
  theme(
    ...
    legend.text = element_text(size = 18, margin = margin(t = 5, b = 5, l = 2, r = 2)),
...
# Stack plots vertically (as columns)
final <- (pair1 / pair2 / pair3) +
...
# Stack plots vertically (as columns)
final <- (pair1_t2 / pair2_t2 / pair3_t2) +
  plot_layout(guides = "collect") &
theme(legend.position = "bottom", legend.title = element_blank(),
      plot.margin = margin(5, 5, 5, 5, "pt"))
