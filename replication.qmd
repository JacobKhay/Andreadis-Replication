...
<!-- Change title, unless the standard in this journal is to use the same title. -->
...
<!-- Exention plot legend text should be bigger. axis labels bigger. Same x-axis tick marks. -->

<!-- Two columns for plots. -->

<!-- Extension titles/captions should be like replication title/captions, not headers. -->


<!-- DK: Make the font in the tables a little bigger. Font in tables can not be different sizes!-->
...
We replicate @andreadis2025 on the correlation between the level and growth of artificial intelligence job openings and education, innovation, and industry factors across U.S. counties from 2014 to 2023. We successfully reproduce their main results and extend the analysis by employing log-population weights to assess robustness. The core associations persist, though most magnitudes shrink. We also highlight unsupported causal claims in @andreadis2025, given its observational design. 
