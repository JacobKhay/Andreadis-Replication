...
<!-- Notes must be more extensive, at least with regard to the issue with Bachelor's share. Self-contained. Done-->
...
<!-- Should be possible to understand the paper by only reading the tables and figures (including their captions). Should also be possible to understand the paper without reading the table or figures. Done-->


<!-- Where are the titles for the tables and the figures? Fixed-->

<!-- Same order (orange/blue or vice versa) in all charts. Done -->
