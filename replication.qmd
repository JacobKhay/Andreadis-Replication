...
<!-- Ask AI if formula 2 is reasonable. Do the math of taking an average explicitly. Done.-->

<!-- This is a bad sentence: "A significant statistical issue arises from the construction of the variables." Why not "an important issue." Also "the variables" should be "labor market tightness." Because that is the only variable which is a problem. Edit rest of paragraph. Fixed.-->

<!-- READ CLOSELY! Example: "multiplied by 100 to express in percentage points." Express what? Fixed-->

<!-- Drop all later discussion of labor market tightness. Fixed-->

<!-- "Figure 1: This figure" seems wrong. Figure 1: is wrong whether or not these are the notes to Figure 1 or if they are the start of a paragraph 1. Fixed  -->

<!-- Shouldn't Figure 1 appear in the Figure 1 subsection, like with tables? Yes, fixed. -->

<!-- "Notes:" seems wrong. We don't label the Notes section of our figures. I STAND CORRECTED! We need *Notes* for all tables and figures. Fixed-->
