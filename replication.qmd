...
<!-- Email authors again about bachelor share issue. NOW. -->

<!-- Fix legend ordering in plot. -->

<!-- Fix table formatting. -->

<!-- There are data problems in the map. Isolate them. Send new email to the authors about them, if the authors are wrong. I see North Slope of ALsaka. And CT as obvious issues. -->

<!-- Cite R (famous 1996 paper), modelsummary fixest and maybe one or two other packages you used. -->

<!-- Add a setup chunk which loads all the libraries you use in one place. -->
