...
<!-- Ask AI if formula 2 is reasonable. Do the math of taking an average explicitly. -->

<!-- This is a bad sentence: "A significant statistical issue arises from the construction of the variables." Why not "an important issue." Also "the variables" should be "labor market tightness." Because that is the only variable which is a problem. Edit rest of paragraph. -->

<!-- READ CLOSELY! Example: "multiplied by 100 to express in percentage points." Express what? -->

<!-- Drop all later discussion of labor market tightness. -->

<!-- "Figure 1: This figure" seems wrong. Figure 1: is wrong whether or not these are the notes to Figure 1 or if they are the start of a paragraph 1.  -->

<!-- Shouldn't Figure 1 appear in the Figure 1 subsection, like with tables? -->

<!-- "Notes:" seems wrong. We don't label the Notes section of our figures. I STAND CORRECTED! We need *Notes* for all tables and figures. -->

<!-- I like the Results section phrasing/framing, but I think it is outdated. Exact percentages are not that interesting. Something like: "Of the 14 coefficients highlighted by AKCLM in their preferred model, 13 of them decrease in absolute value. With log-population weighting, almost all the associations are weaker." -->
