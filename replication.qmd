...
<!-- So, all captions are long, about a paragraph, and include discussions of the data, especially definitions of dependent variable, years, number of counties and so on. -->
...
<!-- Should captions for all figures/tables be handled different, using fig.cap or some other trick? Investigate.  -->
