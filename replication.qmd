...
<!-- DK: There are two outcomes of interest! Fix this paragraph and later paragraphs. Use AI! -->
...
<!-- DK: More room to add stuff in this paragraph. Which variables? Which matter most? -->

We reproduce these results and then extend the analysis by using log-population weights. Under this adjustment, the core associations persist but the estimated magnitudes generally shrink. 
