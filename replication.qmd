...
<!-- Look for garbage, obviously AI-generated, sentences. Delete them! Leaving this in will get us desk-rejected, especially in the Introduction and Conclusion. -->

<!-- How is 'labor market tightness' still in this draft! -->

<!-- Bad grammar: " the share of AI-related job postings in total job postings at the county-year level."!! You really mean:  "AI-related job postings divided by total job postings" -->

<!-- This whole sentence isn't great: "There are two outcome variables, both measures of AI intensity — the share of AI-related job postings in total job postings at the county-year level."   How about: "AKCLM define "AI intensity" as AI-related job postings divided by total job postings. There are two outcome variables: the level of AI intensity and the growth of AI intensity between 2017-2018 and 2022-2023." -->

<!-- Are these sentences doing something: "Together, these outcomes distinguish between where AI jobs are concentrated and where AI adoption is accelerating most rapidly. Tracking both provides insight into which regions gain early access to AI intensity and which experience the fastest growth." -->

<!-- Are these sentences doing stuff for you? "Statistical precision favors patents, significant at the 1% level versus 5% for STEM degree share. STEM degree share thus exhibits larger magnitude while patents per employee exhibits greater precision." Delete these! -->

<!-- We should only discuss Model 4, and explain that we are doing that. -->

<!-- DO NOT ASSUME OTHER PEOPLE ARE CORRECT! ASK AI! Constantly Am.-->

<!-- I am suspicious of "logarithm-of-population". Why not just log-population everywhere. -->
...
Finally, AKCLM's causal interpretations are not supported by the observational nature of their data [@holland1986]. The associations documented do not establish that education, innovation, or industry factors directly cause higher AI intensity. 
...
table_notes <- paste(
  "\\textit{Notes:} This table replicates Table 1 from Andreadis et al. (2025).",
...
table_notes <- paste(
  "\\textit{Notes:} This table replicates Table 2 from AKCLM.",
  "The dependent variable is the change in AI intensity between the 2017–2018 and 2022–2023 averages,",
  "multiplied by 100 to express the change in percentage points.",
...
In the fully specified Model 4, bachelor's share shows a small negative association with the growth of AI intensity under both weighting schemes, suggesting that counties with higher educational attainment in 2017 already had higher baseline AI intensity, leaving less room for growth. House price growth shows minimal independent effect. Among innovation variables, patents per employee declines from 0.06 percentage points under equal weights to 0.04 under log-population weights (a 33% reduction), while STEM degree share declines from 0.08 to 0.05 percentage points (a 38% reduction). Among industry variables, manufacturing intensity shows a negative association of approximately 0.03–0.04 percentage points, ICT intensity declines from 0.12 to 0.07 percentage points (a 42% reduction), and turnover rate — the largest predictor — declines from 0.17–0.18 to 0.11 percentage points (a 39% reduction). The consistent 40% magnitude reductions across innovation and industry variables suggest that these associations are stronger in smaller counties.

### Results

Of the coefficients highlighted by AKCLM in their preferred levels specification, most decrease in absolute value under log-population weighting. STEM degree share shows the most stability across weighting schemes, while bachelor's share, turnover rate, and manufacturing intensity all weaken under population weighting, suggesting these relationships are stronger in smaller counties. ICT intensity and patents per employee are exceptions, becoming slightly larger under population weighting. Overall, the direction of all associations is preserved, but the pattern of magnitude shifts suggests that AI intensity correlates more strongly with education and labor market structure in smaller counties.
