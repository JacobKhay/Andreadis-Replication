...
<!-- How is 'labor market tightness' still in this draft! Gone.-->

<!-- Bad grammar: " the share of AI-related job postings in total job postings at the county-year level."!! You really mean:  "AI-related job postings divided by total job postings" Fixed. -->

<!-- This whole sentence isn't great: "There are two outcome variables, both measures of AI intensity — the share of AI-related job postings in total job postings at the county-year level."   How about: "AKCLM define "AI intensity" as AI-related job postings divided by total job postings. There are two outcome variables: the level of AI intensity and the growth of AI intensity between 2017-2018 and 2022-2023." Fixed -->

<!-- Are these sentences doing something: "Together, these outcomes distinguish between where AI jobs are concentrated and where AI adoption is accelerating most rapidly. Tracking both provides insight into which regions gain early access to AI intensity and which experience the fastest growth." Removed, along with several other garbage sentences-->

<!-- Are these sentences doing stuff for you? "Statistical precision favors patents, significant at the 1% level versus 5% for STEM degree share. STEM degree share thus exhibits larger magnitude while patents per employee exhibits greater precision." Delete these! Deleted -->

<!-- We should only discuss Model 4, and explain that we are doing that. Done. -->

<!-- DO NOT ASSUME OTHER PEOPLE ARE CORRECT! ASK AI! Constantly Am.-->

<!-- I am suspicious of "logarithm-of-population". Why not just log-population everywhere. Done-->
...
AKCLM define "AI intensity" as AI-related job postings divided by total job postings. There are two outcome variables: the level of AI intensity and the growth of AI intensity between 2017-2018 and 2022-2023.
...
Figure 1 displays the spatial distribution and evolution of AI intensity across U.S. counties from 2014 to 2023. Panel A shows that AI intensity is highly concentrated in a small number of coastal metropolitan counties, with most rural and inland counties falling in the 0–0.14% range. Panel B shows that the highest growth in AI intensity between 2018 and 2023 (median: 0.088 percentage points) did not occur in established tech hubs.

We assess robustness by re-estimating AKCLM's preferred specifications weighted by log-population. Of the 5 coefficients that are statistically significant at the 5% level under equal weighting across both dependent variables, only 3 remain significant under log-population weighting. For the level of AI intensity, bachelor's share and STEM degree share remain significant, while patents per employee and manufacturing intensity lose significance. For the growth of AI intensity, STEM degree share remains significant under both weighting schemes. 
...
Second, several associations are sensitive to the weighting scheme. ICT intensity shows the largest magnitude shift, declining by approximately 42% under log-population weights, while patents per employee, STEM degree share, and turnover rate all decline by roughly 33–39%.
