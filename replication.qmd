...
There are two outcome variables. First, the share of AI-related job postings at the county-year level captures the level of AI employment opportunities in a given county and year. Second, the percentage point change in AI job share between 2017-2018 and 2022-2023 captures how AI employment growth varies across counties. Together, these outcomes distinguish between where AI jobs are concentrated (levels) and where AI adoption is accelerating most rapidly (growth). Tracking both dynamics provides insight into which regions gain early access to AI-driven employment and which experience the fastest expansion.
...
This creates denominator contamination or mechanical endogeneity, where both sides of the regression share the same underlying quantity (total job postings), inducing a built-in correlation that exists purely through algebraic construction. This can bias coefficient estimates and overstate statistical significance. The issue is analogous to regressing $Y/Z$ on $Z/X$ where the shared $Z$ induces correlation even when $Y$ and $X$ are actually independent. Kronmal [-@kronmal1993spurious] shows that when the dependent variable is a ratio sharing a component with an independent variable, "regression coefficient estimates for the other independent variables... result in inappropriate conclusions." The paper recommends avoiding ratios in regression analyses when such shared components exist.
...
### Figure 1
Figure 1 displays the spatial distribution and growth of AI job shares across US counties from 2014 to 2023. Panel A shows average AI job shares, while Panel B shows growth between 2018 and 2023.

In Panel A, Santa Clara County, California (8.19 percent) shows 35.6 times the national median AI job share (0.23 percent). Fairfax County, Virginia (6.97 percent) and San Francisco County, California (6.34 percent) show 30.3 and 27.6 times the median respectively. Most rural and inland counties show minimal AI job shares (0–0.14 percent).

In Panel B, Maries, Missouri (12.35 percentage points), Hughes, South Dakota (10.43 percentage points), and Osage, Michigan (9.82 percentage points) show the highest growth between 2018 and 2023. The median growth is 0.088 percentage points, with the ninetieth percentile at 0.93 percentage points and the tenth percentile at -0.29 percentage points.

Counties with high AI job shares in Panel A show moderate growth in Panel B. Counties with zero AI job shares in Panel A show minimal growth in Panel B (0–0.09 percentage points).
