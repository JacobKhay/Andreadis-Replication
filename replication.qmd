...
<!-- DK: Do not use LaTeX unless you have a compelling reason. fancyheader? JK: I removed fancyheader and some of the other ones but AI says float is important for figure placement and I kept the numbering system which is also there -->

<!-- DK: Code must generate the tables. No copy/paste in replication. Done for both tables. -->

<!-- DK: Use fig.cap, not headers, for caoptions in table. Used tbl-cap. I'm not sure if it matters or not. -->

<!-- DK: get rid of causation discussion. Done -->

<!-- DK: Our plot should look like their plot. Check Alaska. Corrected the color scheme in Alaska as well as formatted more like the original -->
