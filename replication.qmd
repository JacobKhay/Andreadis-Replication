...
<!-- Nice if the Tables and Figure show up in the correct Table 1, Table 2, and Figure 1 sections. -->

<!-- "two largest predictors?" I think "most important" is preferred larger. Maybe?  -->

<!-- This phrasing is bad because it is not a comparison: "A one-standard-deviationincrease in tightness corresponds to 0.095 percentage points — 61% of the sample mean of 0.45% — compared with 40% for bachelor’s share" In particular, "corresponds" is a bad word. Better i something like: "We exect two counties which differ by 1 standard deviation in tightness to differ by 0.09 percentage points in AI intensity." -->
...
<!-- "wo-way fixed-effects regression" Correct terminology? "two way?" -->
...
The second dependent variable captures the percentage point change in AI Intensity between the 2017-2018 average and the 2022-2023 average: $\Delta AI_i = \overline{AI}_{i,2022-2023} - \overline{AI}_{i,2017-2018}$.
...
We use R [@ihaka1996r], a free and open-source statistical computing environment, and the tidyverse collection of packages [@tidyverse]. To estimate and display regression models, we use the fixest [@fixest] and modelsummary [@modelsummary] packages.
