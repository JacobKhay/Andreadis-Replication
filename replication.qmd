...
<!-- Remove kableExtra and usmap reference. Done.-->

<!-- Colons must be flush to journal numbers, or however they normally present things. Should not have a lot of spaces around a colon in the References. Example: Science384(6702) : 1306–1308 worked on this, please double check if done precisely-->

<!-- Cite published version of Babina, Tania. Don't include 103745. It is the published version, that number represents the sequential article identifier -->

<!-- Delete garbage that you are not using, like .Rproj, apa.csl and so on. Seems like there may be other random junk.  Maybe data files go in a data/ directory. (Code will need to change, obviously.) Done -->

<!-- Add to README some background. Where did you orginally replicate this from? When did you fork it? Where did you download stuff from? What cleaning did you do? About paragraph. Done  -->
...
**Notes on Map Replication:** We employed the identical methodology from @andreadis2025 for constructing these spatial visualizations, using their provided data.csv file and following their documented mapping approach. However, our replication produced different results from the published maps:
