...
<!-- Quote or italicize or bold package names, like in "fixest (Bergé, 2018) and modelsummary (Arel-Bundock,2022)." I don't know. -->

<!-- Too many em (or is it en?) dashes. Looks like AI. -->

<!-- Explain why only certain variables are included in the tables. -->

<!-- Don't say "We measure"! We didn't measure anything! Use AKCLM. Check all We's. -->

<!-- Why is Unemployed italicized in the formula for showing the problem with labor market tightness. Probably wrong. -->
