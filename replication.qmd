...
<!-- Use "henceforth, AKCLM"? instead of Andreadis et al. (2025)  everywhere -->
...
<!-- Line up columns in table. Numbers with minus signs are off by one. Fixed-->
...
The regression results in Tables 1 and 2 reveal important patterns in both the levels and growth of AI employment across U.S. counties. All coefficients represent percentage point changes in AI job share for a one standard deviation increase in the explanatory variable, since all independent variables are standardized as z-scores.

**Table 1: Levels of AI Job Share** — Between 2014 and 2022, AI-related job postings surged from 0.5 percent to 2.05 percent of all job postings nationally. Counties with higher bachelor's degree attainment show substantially higher AI job intensity: a one standard deviation increase in bachelor's share is associated with a 0.181 percentage point increase in AI job share (column 4), which represents approximately 40 percent of the sample mean AI intensity. Labor market tightness emerges as the strongest predictor, with a one standard deviation increase associated with a 0.277 percentage point increase in AI share, equivalent to roughly 60 percent of the mean AI intensity across counties. Innovation capacity also matters significantly: counties with one standard deviation higher patents per employee exhibit 0.029 percentage points higher AI job shares, while a one standard deviation increase in STEM degree share corresponds to 0.048 percentage points higher AI intensity. Manufacturing-intensive counties face challenges in AI adoption, with a one standard deviation increase in manufacturing intensity associated with a 0.033 percentage point decrease in AI share. Conversely, ICT sector intensity shows a positive association of 0.026 percentage points per standard deviation. The R-squared values range from 0.680 to 0.716, indicating that these demographic, innovation, and industry factors collectively explain approximately 68-72 percent of the variation in county-level AI job intensity after accounting for fixed effects.

**Table 2: Growth in AI Job Share** — During 2018-2023, the median county experienced a modest 0.088 percentage point increase in AI job share, though with substantial heterogeneity: the tenth percentile saw a decline of 0.29 percentage points while the ninetieth percentile experienced growth of 0.93 percentage points. The fastest-growing counties include Maries, Missouri (12.35 percentage point increase), Hughes, South Dakota (10.43 points), and Osage, Michigan (9.82 points), reflecting a shift toward suburban and remote-friendly regions following the COVID-19 pandemic. STEM degree share emerges as the strongest predictor of AI job growth: a one standard deviation increase in 2017 STEM share is associated with a 0.054 percentage point increase in AI job share by 2022-2023 (column 4), which represents approximately 61 percent of the median growth rate. Labor market tightness also plays a critical role, with a one standard deviation increase in 2017 tightness corresponding to a 0.073 percentage point increase in AI share, equivalent to 83 percent of the median growth. Counties with higher turnover rates in 2017 experienced slower AI job growth, with a one standard deviation increase in turnover associated with a 0.042 percentage point smaller increase in AI share. Manufacturing intensity shows a negative but statistically insignificant relationship in the full specification (column 4), while ICT sector intensity exhibits a positive but marginally significant effect. The R-squared values are substantially lower than in Table 1 (ranging from 0.016 to 0.082), indicating that initial county characteristics explain a smaller share of variation in AI job growth compared to AI job levels, suggesting that growth dynamics are influenced by additional factors not captured in the baseline year.
