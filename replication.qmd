...
<!-- Use: citation("modelsummary") and similarly for the other R packages.  -->
...
<!-- 103745 is wrong. Check each reference by hand. -->

<!-- Science384(6702) : 1306–1308 --- spaces around colon seems weird. -->

<!-- Does every entry need a DOI or a URL? -->
...
**Notes:** The table reports the demographic, innovation, and industry determinants of the change in AI shares in a county between 2017–2018 and 2022–2023. Standard errors are clustered at the county level. All coefficients successfully replicate the original results except for Bachelor's share, which shows a discrepancy with the published values.
...
**Notes on Map Replication:** We employed the identical methodology from @andreadis2025 for constructing these spatial visualizations, using their data.csv file and mapping approach. However, our replication produced different results from the published maps. Most notably, Connecticut did not appear in our maps because it was not found in the original data.csv code provided by the authors. This suggests potential differences in data processing or aggregation methods that were not fully documented in the original study. Despite following their documented methodology precisely, the geographic patterns we observe differ from those in the published paper, highlighting the importance of comprehensive data documentation in replication studies.
