...
<!-- Explain wny there is not sub t in formula 4. This is because there is only row per county. -->

<!-- Should there be a constant term in formula 4? Yes. Askig AI! Make sure you can explain what the formulas look like mathematically. What is $alpha_i? -->

<!-- Formula 2 is totally wrong. -->

<!-- "two-way fixed-effects regression" Correct terminology? "two way?" Yes, county and year fixed effects-->

<!-- Nothing like "ΔAI Intensity𝑖". Either "ΔAI𝑖" when referring to the term in the model or "change in AI intensity."  -->
...
<!-- Do not use different terms for the same variable. If you mean "labor market tightness,"" then write that. Do not write just "tightness." -->
