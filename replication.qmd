...
We partially replicate @andreadis2025 on the correlation between the level and growth of artificial intelligence employment across U.S. counties from 2014 to 2023 and a collection of variables involving education, innovation, and industry. We successfully reproduce most of their results and, to assess robustness, extend their analysis by using log-population weights. Only some of the associations persist. We critique the construction of a key variable and their unsupported causal claims. We also illustrate denominator contamination with explicit ratio formulas and a directed acyclic graph (DAG).
...
Notes: The arrows show algebraic construction rather than causal effects. The same component, Total Postings, appears in both ratios, which can induce mechanical correlation.
