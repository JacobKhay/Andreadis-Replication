...
<!-- Make the formatting of the data section look more like the formatting of other articles published in our target journal. -->

<!-- What should the sections be called? Follow the author instructions as well as the examples from published papers in this journal. -->

<!-- The Figure needs a caption, a caption which is obviously a caption, and not part of the main text. -->


<!-- We follow AKCLM in considering column 4 as the baseline model. The results are fairly similar so similar points could be made about the coefficients in other models. -->
