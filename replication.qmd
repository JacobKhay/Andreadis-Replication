...
<!-- Only discuss Model 4 since that is the only thing they discuss! Done.-->

<!-- I don't like this sentence: "Additional visual discrepancies exist between our replicated maps and the published maps." Maybe, "Hundreds of counties have different values in our replication, especially in Panel B." Done. -->

<!-- Print out the paper and have a friends read it aloud to you. Or, at least, read it aloud yourself. WIP -->

<!-- Fix discussion of Figure 1. Fixed. -->

<!-- Why is AI job share still being used? You need to decide on the names of variables and use those names consistently. Fixed, use AI Intensity and change in AI intensity-->

<!-- Might (?) be very useful to have a phrase which refers to both dependent variables at the same time.  Maybe "AI intensity?" But maybe you don't need this. I did the above instead.-->

<!-- Cut lots of stuff! 80% of Figure 1 discussion should go. No one cares about your description of weird counties. Done. -->
