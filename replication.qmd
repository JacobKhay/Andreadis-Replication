...
<!-- Send one email to all authors, informing them about the error in the table. cc me.

subj: Mistake in Table 2 in Andreadis et al. (AEA Papers and Proceedings, 2025)

We believe that there is a mistake in Table 2 in Andreadis et al. (AEA Papers and Proceedings, 2025). We emailed Prof Andreadis about this issue and he has not responded. The published table is:
...
YThe only issue is with the values for Bachelor's share whatever . . .
...
We partially replicate @andreadis2025 on the correlation between the level and growth of artificial intelligence employment and education, innovation, and industry factors across U.S. counties from 2014 to 2023. We successfully reproduce most of their main results and extend the analysis by employing log-population weights to assess robustness. The core associations persist, though almost all magnitudes shrink. We also highlight unsupported causal claims in @andreadis2025, given its observational design.
