...
<!-- DK: Make the paper look more like published papers. -->
    <!-- Authors and affiliations. Institute for Globally Distributed Open Research and Education -->
    <!-- JEL: -->
    <!-- Keywords: -->
...
final_plot <- (p1 / p2) +
  plot_annotation(
    title = "Replication of the Maps from the Article",
    theme = theme(
