setwd('C:/Users/Owner/Desktop/Andreadis-Replication-19/replication_cache/akclm_aea_archive/extracted')
# Column1: Demographics
library(pander)
library(fixest)
library(tidyverse)

data_ai=read_csv('C:/Users/Owner/Desktop/Andreadis-Replication-19/replication_cache/akclm_aea_archive/extracted/data.csv')%>% mutate(state_year=paste0(state,Year)) %>% 
...
data_ai_2017_2022=read_csv('C:/Users/Owner/Desktop/Andreadis-Replication-19/replication_cache/akclm_aea_archive/extracted/data.csv') %>% filter(Year==2017|Year==2018|Year==2022|Year==2023) %>% 
...
# prepare demographics
# right hand side variables are demographics: unemployment rate:unrate, log median household income, share_bac, share_black, share_poverty, log HPI, log population, log immigration.
if (!"immigration" %in% names(data_ai_2017_2022)) data_ai_2017_2022$immigration <- NA_real_
