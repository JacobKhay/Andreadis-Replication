...
The shared \(TotalJobs_{it}\) term appears in both ratios, which can
induce correlation mechanically, as shown in Figure~\ref{fig-dag}.

\begin{figure}[H]

\caption{\label{fig-dag}DAG of denominator contamination between AI
intensity and labor market tightness}
...
Notes: The arrows show algebraic construction rather than causal
effects. The same component, Total Postings, appears in both ratios,
which can induce mechanical correlation.
