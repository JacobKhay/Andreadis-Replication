...
through algebraic construction.
...
conclusions.'' The paper recommends avoiding ratios in regression
analyses when such shared components exist.
...
Table 1 presents cross-sectional estimates of the determinants of AI job
intensity over 2014--2023. All regressors are standardized, permitting
direct comparison of magnitudes across predictors. Column 4 --- the
preferred specification --- includes the full control set alongside
county and year fixed effects; all subsequent discussion refers to this
column. Labor market tightness (0.28, p \textless{} 0.001) and
bachelor's degree share (0.18, p \textless{} 0.001) are the two largest
predictors of AI job intensity in Table 1. Tightness carries a
coefficient 52\% larger than bachelor's share. A one-standard-deviation
increase in tightness corresponds to 0.095 percentage points --- 61\% of
the sample mean of 0.45\% --- compared with 40\% for educational
attainment. Both coefficients are statistically significant at the 0.1\%
level. Tightness thus exhibits both a larger point estimate and greater
practical magnitude. Within the innovation cluster of Table 1, STEM
degree share (0.048, p \textless{} 0.05) carries a coefficient 62\%
larger than patents per employee (0.029, p \textless{} 0.01). A
one-standard-deviation difference in STEM credentials corresponds to
11\% of mean AI intensity, compared with 7\% for patenting. However,
statistical precision favors patents, which are significant at the 1\%
level versus 5\% for STEM share. STEM thus exhibits larger magnitude
while patents exhibit greater precision. Across industry factors in
Table 1, ICT sector intensity (0.026, p = 0.058) and manufacturing
intensity (-0.033, p \textless{} 0.01) exhibit similar effect sizes but
opposite signs. Counties with one standard deviation higher ICT
concentration have 0.059 percentage points more AI jobs than
manufacturing-oriented counties with equivalent concentration.
Manufacturing shows a 30\% larger effect size than ICT (0.033
vs.~0.026). The coefficient on manufacturing is statistically
significant at the 1\% level, whereas the ICT coefficient is significant
only at the 10\% level. Manufacturing thus exhibits both a larger point
estimate and greater precision. Comparing education measures within
Table 1, bachelor's share (0.18, p \textless{} 0.001) carries a
coefficient 3.8 times larger than STEM degree share (0.048, p
\textless{} 0.05). A one-standard-deviation difference in bachelor's
attainment corresponds to 0.13 percentage points --- 40\% of mean AI
intensity --- compared with 11\% for STEM credentials. The bachelor's
share coefficient is also more precisely estimated, significant at the
0.1\% level versus 5\% for STEM share. Bachelor's attainment thus
dominates on both magnitude and statistical precision.
...
2022--2023. All regressors are standardized, with explanatory variables
measured in 2017. Column 4 includes the full control set and serves as
the preferred specification; all subsequent discussion refers to this
column. Comparing STEM degree share (0.054, p \textless{} 0.001) with
labor market tightness (0.073, p \textless{} 0.01), tightness carries a
coefficient 36\% larger. A one-standard-deviation increase in tightness
corresponds to 0.019 more percentage points of growth than an equivalent
shift in STEM credentials. Relative to median growth of 0.088 percentage
points, tightness accounts for 83\% and STEM for 61\%. Both coefficients
are statistically significant at the 1\% level. Tightness thus exhibits
a larger point estimate, though the gap is considerably narrower than in
the levels specification of Table 1. Within the labor market variables
of Table 2, turnover rate (-0.042, p = 0.072) carries a coefficient 2.7
times larger in magnitude than large establishment share (-0.016, p =
0.47). A one-standard-deviation difference in turnover corresponds to
48\% of median growth, compared with 18\% for establishment size.
Statistical precision also favors turnover, which approaches
conventional significance at the 10\% level, while large establishment
share shows no statistical evidence. Turnover thus exhibits both larger
magnitude and greater precision, though neither estimate is measured
with high confidence. Within industry composition in Table 2,
manufacturing intensity (-0.013, p = 0.48) and ICT sector intensity
(0.014, p = 0.42) show nearly identical effect sizes but opposite signs.
A one-standard-deviation shift from manufacturing toward ICT
concentration corresponds to 0.027 percentage points of additional
growth --- roughly 15--16\% of median growth for each variable
individually. Neither coefficient approaches statistical significance.
This contrasts sharply with Table 1, where manufacturing achieved
significance at the 1\% level with a coefficient of 0.033. Both effect
sizes and statistical precision collapse in the dynamic specification.
