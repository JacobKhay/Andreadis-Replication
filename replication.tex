...
These maps display the spatial distribution of AI job share across US
counties. AI job share represents the proportion of job postings
mentioning AI-related terms out of total job postings in each county,
expressed as a percentage. Panel A shows the average AI job share from
2014 to 2023, revealing geographic concentration patterns with coastal
metropolitan areas and technology hubs exhibiting higher adoption rates
(0.14--0.38 percent) compared to rural and inland regions (0--0.14
percent). Panel B displays the percentage-point change in AI share
between two pooled periods (2018 and 2023), capturing the growth
dynamics where most counties show increases ranging from 0 to 12.35
percentage points. The contrast between panels reveals that counties
with initially high AI adoption continued to strengthen their position,
while most counties experienced modest growth. We were unable to fully
replicate the published maps using the authors' provided data.csv file,
as Connecticut appears with N/A values because the data coded
Connecticut with FIPS 9999 (state-level) rather than individual county
codes.
