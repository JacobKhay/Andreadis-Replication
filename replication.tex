...
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{3cm}>{\centering\arraybackslash}p{1.3cm}>{\centering\arraybackslash}p{1.3cm}>{\centering\arraybackslash}p{1.3cm}>{\centering\arraybackslash}p{1.3cm}>{\centering\arraybackslash}p{1.3cm}}
\toprule
  & (1) & (2) & (3) & (4) & (5)\\
\midrule
Bachelor's share & \num{0.1906}*** &  &  & \num{0.1817}*** & \num{0.1035}**\\
...
R² & 0.69739 & 0.68012 & 0.67989 & 0.69827 & 0.71558\\
\bottomrule
...
industry determinants of the change in AI shares in a county. Standard
