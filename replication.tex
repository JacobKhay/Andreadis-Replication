...
Comparing labor market tightness (0.28, SE = 0.06) with bachelor's share
(0.18, SE = 0.05) in Table 1, counties with one standard deviation
higher labor market tightness exhibit 0.10 percentage points more AI
jobs than similarly educated counties. Both coefficients achieve strong
statistical significance with t-statistics exceeding 3.5, but tightness
shows 55\% larger practical effects. The average AI job share across
counties is 0.45 percent, meaning tightness accounts for 62\% of the
mean while bachelor's share accounts for 40\%. Despite both being
statistically indistinguishable from zero at conventional levels, their
practical importance differs substantially.

Within the innovation category of Table 1, comparing STEM degrees share
(0.05, SE = 0.02) with patents per employee (0.03, SE = 0.01) reveals
that STEM credentials show 67\% larger coefficients than patenting
intensity. However, the statistical evidence diverges from practical
magnitude. Patents per employee achieves stronger statistical
significance (t = 2.60, p \textless{} 0.01) compared to STEM share (t =
2.32, p \textless{} 0.05), yet both effects remain modest in practical
terms. Counties differing by one standard deviation in STEM credentials
show only 11\% of mean AI intensity, while patent differences account
for 7\%. The statistical precision favors patents despite smaller
economic magnitude.

Across industry factors in Table 1, ICT sector intensity (0.03, SE =
0.01) and manufacturing intensity (-0.03, SE = 0.01) exhibit symmetric
magnitudes but opposite signs. Counties with one standard deviation
higher ICT concentration have 0.06 percentage points more AI jobs than
manufacturing-oriented counties with equivalent concentration.
Manufacturing intensity achieves conventional statistical significance
(t = 3.08, p \textless{} 0.01), while ICT intensity remains marginally
significant (t = 1.90, p \textless{} 0.10). Despite similar practical
magnitudes representing 7\% of mean AI intensity each, the statistical
evidence differs markedly. This suggests manufacturing's negative
association is measured with greater certainty than ICT's positive
relationship.

Comparing education measures within Table 1, bachelor's share (0.18, SE
= 0.05) dominates STEM share (0.05, SE = 0.02) by a factor of 3.6.
Counties with one standard deviation higher bachelor's attainment have
0.13 percentage points more AI jobs than counties with equivalent STEM
credential intensity. Both achieve statistical significance, but
bachelor's share shows substantially larger practical importance,
accounting for 40\% of mean AI intensity versus 11\% for STEM
credentials. The standard errors suggest both are measured with
comparable precision (t = 3.59 vs t = 2.32), indicating the magnitude
difference reflects genuine economic importance rather than measurement
quality.

Table 2 reveals weaker relationships for growth dynamics. Comparing STEM
degrees share (0.05, SE = 0.02) with labor tightness (0.07, SE = 0.02),
counties with one standard deviation higher 2017 tightness experienced
0.02 percentage points more growth than counties with equivalent STEM
credentials. Both achieve statistical significance (t = 3.31 for STEM, t
= 3.09 for tightness), but the practical difference is modest. Relative
to median growth of 0.09 percentage points, tightness accounts for 81\%
while STEM accounts for 60\%. Unlike Table 1 where tightness dominated,
the growth analysis shows more balanced practical importance despite
maintained statistical significance.

Within Table 2 labor market variables, comparing turnover rate (-0.04,
SE = 0.02) with large establishments share (-0.02, SE = 0.02), counties
with one standard deviation higher labor turnover grew 0.02 percentage
points slower than counties with more large establishments. Turnover
achieves marginal statistical significance (t = 1.80, p \textless{}
0.10) while large establishments remains statistically insignificant (t
= 0.72, p \textgreater{} 0.10). The practical magnitudes differ
modestly, with turnover representing 47\% of median growth and large
establishments 18\%. Here statistical and practical significance align,
both favoring turnover as the more reliable predictor despite neither
achieving strong statistical evidence.

Comparing industry composition within Table 2, manufacturing intensity
(-0.01, SE = 0.02) and ICT sector intensity (0.01, SE = 0.02) show
symmetric but statistically weak relationships. Counties with one
standard deviation higher ICT concentration grew 0.02 percentage points
more than manufacturing-oriented counties. Neither achieves conventional
statistical significance (t = 0.71 for manufacturing, t = 0.81 for ICT),
and both show minimal practical importance at 14-15\% of median growth.
This contrasts sharply with Table 1 where manufacturing showed strong
statistical and practical significance. The growth analysis reveals
these structural factors matter for levels but not for dynamic changes,
highlighting the distinction between cross-sectional and temporal
variation.
